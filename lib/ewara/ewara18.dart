...
class ewara18 extends StatefulWidget {
  @override
  _ewara18State createState() => _ewara18State();
}

class _ewara18State extends State<ewara18> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara18.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara17()));
                        setState(() {
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara19()));
                      },
                      child: Container(
                        // padding: EdgeInsets.fromLTRB(3, 0, 3, 0),
                        decoration: BoxDecoration(
