...
class baiany21 extends StatefulWidget {
  @override
  _baiany21State createState() => _baiany21State();
}

class _baiany21State extends State<baiany21> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany21.jpg'),
            )
        ),
        child: Column(
