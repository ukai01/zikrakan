...
import 'ewara9.dart';
import 'ewara11.dart';
class ewara10 extends StatefulWidget {
  @override
  _ewara10State createState() => _ewara10State();
}

class _ewara10State extends State<ewara10> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara10.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara9()));
                        setState(() {
