...
class baiany1 extends StatefulWidget {
  @override
  _baiany1State createState() => _baiany1State();
}

class _baiany1State extends State<baiany1> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany1.jpg'),
            )
        ),
        child: Column(
