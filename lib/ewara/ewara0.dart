...
class ewara0 extends StatefulWidget {
  @override
  _ewara0State createState() => _ewara0State();
}

class _ewara0State extends State<ewara0> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara0.jpg'),
            )
        ),
        child: Column(
