...
class ewara6 extends StatefulWidget {
  @override
  _ewara6State createState() => _ewara6State();
}

class _ewara6State extends State<ewara6> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara6.jpg'),
            )
        ),
        child: Column(
