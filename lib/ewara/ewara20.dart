...
import 'ewara19.dart';
class ewara20 extends StatefulWidget {
  @override
  _ewara20State createState() => _ewara20State();
}

class _ewara20State extends State<ewara20> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara20.jpg'),
            )
        ),
        child: Column(
