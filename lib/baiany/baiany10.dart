...
class baiany10 extends StatefulWidget {
  @override
  _baiany10State createState() => _baiany10State();
}

class _baiany10State extends State<baiany10> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany10.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany9()));
                        setState(() {
