...
import 'package:zikrakan/ewara/ewara15.dart';
import 'package:zikrakan/main.dart';
import 'package:zikrakan/ewara/ewara0.dart';
import 'package:zikrakan/baiany/baany0.dart';
import 'baiany15.dart';
import 'baiany17.dart';
class baiany16 extends StatefulWidget {
  @override
  _baiany16State createState() => _baiany16State();
}

class _baiany16State extends State<baiany16> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany16.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara15()));
                        setState(() {
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany16()));
                      },
                      child: Container(
                        padding: EdgeInsets.fromLTRB(3, 0, 3, 0),
                        decoration: BoxDecoration(
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany17()));
                      },
                      child: Container(
                        // padding: EdgeInsets.fromLTRB(3, 0, 3, 0),
                        decoration: BoxDecoration(
