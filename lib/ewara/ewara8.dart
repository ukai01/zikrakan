...
import 'ewara7.dart';
import 'ewara9.dart';
class ewara8 extends StatefulWidget {
  @override
  _ewara8State createState() => _ewara8State();
}

class _ewara8State extends State<ewara8> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara8.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara7()));
                        setState(() {
