...
import 'ewara14.dart';
import 'ewara16.dart';
class ewara15 extends StatefulWidget {
  @override
  _ewara15State createState() => _ewara15State();
}

class _ewara15State extends State<ewara15> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara15.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara14()));
                        setState(() {
