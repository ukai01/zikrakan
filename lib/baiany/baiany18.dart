...
import 'baiany19.dart';
class baiany18 extends StatefulWidget {
  @override
  _baiany18State createState() => _baiany18State();
}

class _baiany18State extends State<baiany18> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany18.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany19()));
                      },
                      child: Container(
                        // padding: EdgeInsets.fromLTRB(3, 0, 3, 0),
                        decoration: BoxDecoration(
