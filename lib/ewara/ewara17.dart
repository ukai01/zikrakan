...
class ewara17 extends StatefulWidget {
  @override
  _ewara17State createState() => _ewara17State();
}

class _ewara17State extends State<ewara17> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara17.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara16()));
                        setState(() {
