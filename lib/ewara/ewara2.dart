...
import 'ewara1.dart';
import 'ewara3.dart';
class ewara2 extends StatefulWidget {
  @override
  _ewara2State createState() => _ewara2State();
}

class _ewara2State extends State<ewara2> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara2.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara1()));
                        setState(() {
