...
class ewara14 extends StatefulWidget {
  @override
  _ewara14State createState() => _ewara14State();
}

class _ewara14State extends State<ewara14> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara14.jpg'),
            )
        ),
        child: Column(
