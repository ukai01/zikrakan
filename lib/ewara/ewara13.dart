...
import 'ewara12.dart';
import 'ewara14.dart';
class ewara13 extends StatefulWidget {
  @override
  _ewara13State createState() => _ewara13State();
}

class _ewara13State extends State<ewara13> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara13.jpg'),
            )
        ),
        child: Column(
