...
import 'package:zikrakan/ewara/ewara1.dart';
import 'package:zikrakan/main.dart';
import 'package:zikrakan/ewara/ewara0.dart';
import 'package:zikrakan/baiany/baany0.dart';
import 'ewara15.dart';
import 'ewara17.dart';
class ewara16 extends StatefulWidget {
  @override
  _ewara16State createState() => _ewara16State();
}

class _ewara16State extends State<ewara16> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara16.jpg'),
            )
        ),
        child: Column(
