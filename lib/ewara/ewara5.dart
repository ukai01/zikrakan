...
import 'ewara4.dart';
import 'ewara6.dart';
class ewara5 extends StatefulWidget {
  @override
  _ewara5State createState() => _ewara5State();
}

class _ewara5State extends State<ewara5> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara5.jpg'),
            )
        ),
        child: Column(
