...
import 'baiany11.dart';
import 'baiany13.dart';
class baiany12 extends StatefulWidget {
  @override
  _baiany12State createState() => _baiany12State();
}

class _baiany12State extends State<baiany12> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany12.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany11()));
                        setState(() {
