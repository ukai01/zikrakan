...
class baiany3 extends StatefulWidget {
  @override
  _baiany3State createState() => _baiany3State();
}

class _baiany3State extends State<baiany3> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany3.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany2()));
                        setState(() {
