...
class baiany0 extends StatefulWidget {
  @override
  _baiany0State createState() => _baiany0State();
}

class _baiany0State extends State<baiany0> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('images/baiany0.jpg'),
          )
        ),
        child: Column(
