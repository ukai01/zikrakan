...
class baiany5 extends StatefulWidget {
  @override
  _baiany5State createState() => _baiany5State();
}

class _baiany5State extends State<baiany5> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany6.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany4()));
                        setState(() {
