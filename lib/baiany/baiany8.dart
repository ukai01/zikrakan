...
import 'baiany7.dart';
import 'baiany9.dart';
class baiany8 extends StatefulWidget {
  @override
  _baiany8State createState() => _baiany8State();
}

class _baiany8State extends State<baiany8> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany8.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany7()));
                        setState(() {
