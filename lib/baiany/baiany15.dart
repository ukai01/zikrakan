...
import 'baiany14.dart';
import 'baiany16.dart';
class baiany15 extends StatefulWidget {
  @override
  _baiany15State createState() => _baiany15State();
}

class _baiany15State extends State<baiany15> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany15.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany14()));
                        setState(() {
