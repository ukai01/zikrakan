...
import 'package:zikrakan/baiany/baiany20.dart';
import 'package:zikrakan/main.dart';
import 'package:zikrakan/ewara/ewara0.dart';
import 'package:zikrakan/baiany/baany0.dart';
import 'baiany18.dart';
import 'baiany20.dart';
class baiany19 extends StatefulWidget {
  @override
  _baiany19State createState() => _baiany19State();
}

class _baiany19State extends State<baiany19> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/baiany19.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany18()));
                        setState(() {
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => baiany20()));
                      },
                      child: Container(
                        // padding: EdgeInsets.fromLTRB(3, 0, 3, 0),
                        decoration: BoxDecoration(
