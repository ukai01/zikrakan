...
import 'ewara6.dart';
import 'ewara8.dart';
class ewara7 extends StatefulWidget {
  @override
  _ewara7State createState() => _ewara7State();
}

class _ewara7State extends State<ewara7> {
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ewara7.jpg'),
            )
        ),
        child: Column(
              ...
              children: <Widget>[
                ...
                Material(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        advancedA.stop();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ewara6()));
                        setState(() {
